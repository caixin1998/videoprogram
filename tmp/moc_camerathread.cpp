...
QT_MOC_LITERAL(1, 13, 9), // "showImage"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "img"
QT_MOC_LITERAL(4, 28, 5), // "start"
QT_MOC_LITERAL(5, 34, 13), // "record_camera"
QT_MOC_LITERAL(6, 48, 9), // "nextFrame"
QT_MOC_LITERAL(7, 58, 10) // "play_video"

    },
    "CameraThread\0showImage\0\0img\0start\0"
    "record_camera\0nextFrame\0play_video"
};
...
void CameraThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->record_camera(); break;
        case 3: _t->nextFrame(); break;
        case 4: _t->play_video(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraThread::showImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraThread::showImage(QImage _t1)
{
